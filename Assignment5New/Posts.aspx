    ...
    <div id="mainBody">
        ...
        <section>
				<table>
                    ...
                    <tr><td><asp:Label runat="server" ID="lblResults" BackColor="Red"></asp:Label></td><td><asp:Button runat="server" ID="btnPost" OnClick="AddPost" Text="Post"></asp:Button></td></tr>
				</table> <br/><br/>
    	</section>
